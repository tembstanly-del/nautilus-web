...
export default function ValueProp() {
    return (
        <section className="py-24 px-6 bg-nautilus-deep text-nautilus-sand">
            <div className="max-w-6xl mx-auto">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    <div>
                        <h2 className="text-3xl md:text-5xl font-serif mb-8 leading-tight">
                            A Generalist in a <br />
                            <span className="text-nautilus-gold italic">Specialist World.</span>
                        </h2>
                        <p className="text-lg text-nautilus-sand/80 font-light leading-relaxed mb-8">
                    ...
                    <div className="grid gap-6">
                        {REASONS_TO_CHOOSE.map((reason) => (
                            <div key={reason.title} className="flex items-start group">
                                <CheckCircle2 className="w-6 h-6 text-nautilus-gold mt-1 mr-4 flex-shrink-0 group-hover:scale-110 transition-transform" />
                                <div>
